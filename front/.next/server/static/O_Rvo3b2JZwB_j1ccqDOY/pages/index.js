...
var PostForm_PostForm = function PostForm() {
  ...
  var imageInput = Object(external_react_["useRef"])(); // 글 작성 후, TextArea 비워주기 
  ...
  var onChangeText = Object(external_react_["useCallback"])(function (e) {
    // props로 들어가는 함수는 무조건 useCallback
    setText(e.target.value);
  }, []);
  var onChangeImages = Object(external_react_["useCallback"])(function (e) {
    console.log(e.target.files); // e.target.files안에 업도드 할 파일이 들어있다. (=유사배열)

    /* FormData 사용 */

    var imageFormData = new FormData(); // FormData()를 브라우저에서 제공 
  ...
  var onClickImageUpload = Object(external_react_["useCallback"])(function () {
    imageInput.current.click();
  }, [imageInput.current]);
  var onRemoveImage = Object(external_react_["useCallback"])(function (index) {
    return function () {
      dispatch({
  ...
  return /*#__PURE__*/external_react_default.a.createElement(external_antd_["Form"], {
  ...
  }, /*#__PURE__*/external_react_default.a.createElement(external_antd_["Input"].TextArea, {
    maxLength: 140,
  ...
  }, "\uC774\uBBF8\uC9C0 \uC5C5\uB85C\uB4DC"), /*#__PURE__*/external_react_default.a.createElement(external_antd_["Button"], {
    type: "primary",
    style: {
      float: 'right'
    },
  ...
  }, "\uC9F9\uC9F9")), /*#__PURE__*/external_react_default.a.createElement("div", null, imagePaths.map(function (v, i) {
    return /*#__PURE__*/external_react_default.a.createElement("div", {
      ...
      src: "http://localhost:3067/".concat(v),
      style: {
        width: '200px'
      },
      alt: v
    }), /*#__PURE__*/external_react_default.a.createElement("div", null, /*#__PURE__*/external_react_default.a.createElement(external_antd_["Button"], {
      onClick: onRemoveImage(i)
    }, "\uC81C\uAC70")));
  })));
};

/* harmony default export */ var containers_PostForm = (PostForm_PostForm);
...
var pages_Home = function Home() {
  var _useSelector = Object(external_react_redux_["useSelector"])(function (state) {
    return state.user;
      ...
      me = _useSelector.me; // 구조분해로 간단하게 표현 
  ...
  var dispatch = Object(external_react_redux_["useDispatch"])();
  var countRef = Object(external_react_["useRef"])([]); // 보냈던 lastId들 기억하는 배열: []

  var onScroll = Object(external_react_["useCallback"])(function () {
    ...
    if (window.scrollY + document.documentElement.clientHeight + 300 > document.documentElement.scrollHeight) {
      ...
      if (hasMorePost) {
        ...
        if (!countRef.current.includes(lastId)) {
          // 한번 보냈었던 lastId는 다시 보내지 않도록 (=동일한 REQUEST 2번씩 일어나는 현상 방지)
          dispatch({
  ...
  return /*#__PURE__*/external_react_default.a.createElement("div", null, me && /*#__PURE__*/external_react_default.a.createElement(containers_PostForm, null), mainPosts.map(function (c) {
    return /*#__PURE__*/external_react_default.a.createElement(PostCard["a" /* default */], {
      key: c.id,
      post: c
    });
  }));
...
pages_Home.getInitialProps = /*#__PURE__*/function () {
  var _ref = Object(asyncToGenerator["a" /* default */])( /*#__PURE__*/regenerator_default.a.mark(function _callee(context) {
    return regenerator_default.a.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            // _app.js의 (context.ctx)를 각 컴포넌트에서는 (context)로 받는다.
...
var PostCard_PostCard = function PostCard(_ref) {
  ...
  var dispatch = Object(external_react_redux_["useDispatch"])();
  var isLiked = me && post.Likers && post.Likers.find(function (v) {
    return v.id === me.id;
  }); // 내가 '좋아요' 했었는지 
  ...
  }))), commentFormOpened && /*#__PURE__*/external_react_default.a.createElement(external_react_default.a.Fragment, null, /*#__PURE__*/external_react_default.a.createElement(external_antd_["Form"], {
  ...
  }, "\uC090\uC57D")), /*#__PURE__*/external_react_default.a.createElement(external_antd_["List"], {
