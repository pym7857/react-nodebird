...
function _createSuper(Derived) { var hasNativeReflectConstruct = _isNativeReflectConstruct(); return function () { var Super = getPrototypeOf_getPrototypeOf(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = getPrototypeOf_getPrototypeOf(this).constructor; result = construct_default()(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return _possibleConstructorReturn(this, result); }; }
  ...
  _createClass(MyDocument, [{
    ...
    value: function render() {
      var _this$props$helmet = this.props.helmet,
          ...
          helmet = _objectWithoutProperties(_this$props$helmet, ["htmlAttributes", "bodyAttributes"]); // static getInitialProps에서 return한 props값


      var htmlAttrs = htmlAttributes.toComponent(); // 객체형식 -> 컴포넌트형식 

      var bodyAttrs = bodyAttributes.toComponent(); // 객체형식 -> 컴포넌트형식 
      // helmet : <html>,<body>를 제외한, <meta>, <script>, <style>.. 등등이 들어있는 배열객체

      return /*#__PURE__*/external_react_default.a.createElement("html", null, /*#__PURE__*/external_react_default.a.createElement("head", htmlAttrs, this.props.styleTags, values_default()(helmet).map(function (el) {
        return el.toComponent();
      }), "    "), /*#__PURE__*/external_react_default.a.createElement("body", bodyAttrs, /*#__PURE__*/external_react_default.a.createElement(next_document["Main"], null),  true && /*#__PURE__*/external_react_default.a.createElement("script", {
        src: "https://polyfill.io/v3/polyfill.min.js?features=es6,es7,es8,es9,NodeList.prototype.forEach&flags=gated"
      }), /*#__PURE__*/external_react_default.a.createElement(next_document["NextScript"], null)));
    }
  }], [{
    key: "getInitialProps",
    value: function getInitialProps(context) {
      // 함수형이 아니라 class로 쓰게되면, getInitialProps앞에 static이 붙는다.
      var sheet = new external_styled_components_["ServerStyleSheet"]();
      var page = context.renderPage(function (App) {
        return function (props) {
          return sheet.collectStyles( /*#__PURE__*/external_react_default.a.createElement(App, props));
        };
      }); // _app.js(=App)를 호출한다. (_document.js가 더 상위 이다.)
...
_document_MyDocument.propTypes = {
  ...
  styleTags: external_prop_types_default.a.object.isRequired
};
